...
#include <SDL2/SDL.h>       // Correct include for SDL2
#include <SDL2/SDL_version.h> // Ensure proper path for SDL_version
//#include <SDL2/SDL_begin_code.h> // Correct path for begin_code.h (if needed)
